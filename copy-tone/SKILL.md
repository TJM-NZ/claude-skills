...
Read `PRODUCT.md`, `CLAUDE.md`, existing brand/tone docs. Sample 5-10 files with user-facing text (landing pages, emails, UI components, error messages) to feel how the product currently talks. Identify the audience and their relationship with the product — browsing, evaluating, actively using, or troubleshooting.
