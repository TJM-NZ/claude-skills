...
### Audit & Review Skills
- **angry-reviewer** - Codebase review from a senior engineer perspective. Finds real problems, calls them out bluntly.
...
```bash
cd ~/.claude/skills
ln -s ~/claude-skills/angry-reviewer angry-reviewer
...
```bash
/angry-reviewer    # Review your codebase
